<img class="page-header-image" src="dancing.jpg" alt="let's contra!">
...
<div class="page-content">
    ...
    <div class="faq-group">
        ...
        <div class="faq-answer">
            ...
            so we're expecting weather in the 70s! Dress accordingly.
        </div>
    </div>
    <div class="faq-group">
        <div class="faq-question">
        ...
        <div class="faq-answer">
            No need to get us a gift, in fact we prefer that you don't.<br>
            If, for whatever reason, you feel obliged to give something,
            please feel free to donate of our favorite organizations, including:<br>
    ...
    <div class="faq-group">
        <div class="faq-question">
            Didn't this website used to have something about contra dancing? Or jazz?
        </div>
        <div class="faq-answer">
            Originally, we were considering doing contra dancing (line dancing)
            at our wedding, and then a jazz band, but tbh booking a band has been
            a bit of a struggle. Suffice to say that dancing will be done.
        </div>
    </div>
    <div class="faq-group">
        <div class="faq-question">
